---
description: Enforce coding rules by auditing the actual codebase for violations
---

# Enforce Coding Rules

First run `/coding-rules:add-or-update` to ensure CLAUDE.md has the latest rules.
