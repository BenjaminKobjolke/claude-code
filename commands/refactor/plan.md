...
4. Create PLAN.md with the following structure:
   ...
   **Session Boundaries**: Note where /handoff:create should be used if the refactoring spans multiple sessions

5. Present the plan to the user. Do NOT implement any changes. This command only plans, similar to how /bugs:collect only documents.
