...
Read CLAUDE.md and check if there is info how to run tests.
If not tell user he first has to setup testing using `/xida:testing-setup` command

Otherwise run tests and fix errors.
