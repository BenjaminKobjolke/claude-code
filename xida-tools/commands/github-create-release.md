...
Read `$CLAUDE_PROJECT_DIR/docs/CREATE_NEW_GITHUB_RELEASE.md` first. If it does not exist, tell the user to run `/xida-tools:github-setup` first and stop.

## Step-by-Step Workflow

### 1. Determine version

- If `$ARGUMENTS` contains a version string, use that (e.g. `/xida-tools:github-create-release 1.2.0`)
